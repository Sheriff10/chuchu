    ...
    return (
        <div className="wrap py-16">
            ...
            <div className="wrap mt-16 text-center p-5">
                ...
                <span className='italic text-3xl'>$CHUCHU is Achi’s little sister Achi is the dog in the $WIF meme Chuchu is cute, we believe she deserves a billion too <br /> Evidence on @ma_babezz on instagram            </span>
            </div>
